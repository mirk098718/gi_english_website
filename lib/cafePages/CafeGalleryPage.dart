...
import 'CafeCommunityNoticePage.dart';

class CafeGalleryPage extends StatefulWidget {
  const CafeGalleryPage({Key? key}) : super(key: key);

  @override
  _CafeGalleryPageState createState() => _CafeGalleryPageState();
}

class _CafeGalleryPageState extends State<CafeGalleryPage> {

  List<ButtonState> buttonStateList = [
    ButtonState("Notice Board", BehaviorColor.colorOnDefault, CafeCommunityNoticePage()),
    ButtonState("Gallery", BehaviorColor.colorOnClick, CafeGalleryPage()),
    ButtonState("QnA", BehaviorColor.colorOnDefault, CafeAboutPage()),
