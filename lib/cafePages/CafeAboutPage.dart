...
class CafeAboutPage extends StatefulWidget {
  const CafeAboutPage({Key? key}) : super(key: key);

  @override
  _CafeAboutPageState createState() => _CafeAboutPageState();
}

class _CafeAboutPageState extends State<CafeAboutPage> {

  List<ButtonState> buttonStateList = [
    ButtonState("Gi글림아일랜드", BehaviorColor.colorOnClick, CafeAboutPage()),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text("GLEAM ISLAND 어학원",style: TextStyle(fontFamily: "Jalnan", fontSize: 15, color: Palette.mainMediumPurple)),
          SizedBox(
            height: 20,
          ),
          Text("Gi 글림아일랜드 어학원은,\n"
          ...
          Text("GLEAM ISLAND 어학원",style: TextStyle(fontFamily: "Jalnan", fontSize: 15, color: Palette.mainLime)),
          SizedBox(
            height: 20,
          ),
          Text("Gi English 키즈카페 Gi 글림아일랜드 영어키즈카페는 Gi 글림아일랜드 어학원 과 협업하여 프로그램의 전문성을 더하고, \n"
